...
const url = `https://www.instagram.com/graphql/query/?query_hash=69cba40317214236af40e7efa697781d&variables={"id":"47354140025","first":12}`;

export default class Instagram extends React.Component {
  state = { photos: [], loading: true }

  // Your specifications
  INSTAGRAM_ID = "47354140025"
  THUMBNAIL_WIDTH = 640
  PHOTO_COUNT = 30
  ...
  async componentDidMount() {
    try {
      ...
      const response = await fetch(
        `https://www.instagram.com/graphql/query?query_id=17888483320059182&variables={%22id%22:%2247354140025%22,%22first%22:30,%22after%22:null}`
      )
